...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
    Picture pix = new Picture("M8\\L6\\pixLab\\pixLab\\images\\gorge.jpg");
    pix.explore();
    
    
    Picture p = new Picture("M8\\L6\\pixLab\\pixLab\\images\\gorge.jpg");
    Picture smallP = p.scale(0.25, 0.25);
    smallP.write("M8\\L6\\pixLab\\pixLab\\images\\smallgorge.jpg");
    smallP.explore();
  }  
